...
const templateFiles = fs
    .readdirSync(path.join(CLI_PATH, 'templates/vue'))
...
test('return help usage how to use create-cocos-plugin', () => {
    const { stdout } = run(['--help'], { cwd: __dirname });
    const message = 'Usage: create-cocos-plugin [OPTION]... [DIRECTORY]';
    expect(stdout).toContain(message);
});

test('return help usage how to use create-cocos-plugin with -h alias', () => {
